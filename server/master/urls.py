...
from master.views import UserListView, UserDetailVeiw, UserAuthRequestView, CourseApprovalView, NotifycationReport, HandleReport

urlpatterns =[
    path('user/', UserListView.as_view(), name = 'UserList'),
    path('user/course/', CourseApprovalView.as_view(), name = 'CourseApproval'),
