                                    ...
                                    <Link to={`/profile/${element.follower_user_username}`}>
                                        <div className="flex items-center gap-3 px-4 py-2">
                                            <div className="w-[20%] rounded-full overflow-hidden border-2 border-solid border-gray-200">
                                                <img className="w-full h-full p-2" src={`${SERVER + element.follower_user_img_path}`} alt={element.follower_user_name} />
                                            </div>
                            ...
                            : followList.map((element, i) => {
                                return (
                                    <Link to={`/profile/${element.follow_user_username}`}>
                                        <div className="flex items-center gap-3 px-4 py-2">
                                            <div className="w-[20%] rounded-full overflow-hidden border-2 border-solid border-gray-200">
                                                <img className="w-full h-full p-2" src={`${SERVER + element.follow_user_img_path}`} alt={element.follow_user_name} />
                                            </div>
                                            <div className="w-[50%] flex flex-col">
